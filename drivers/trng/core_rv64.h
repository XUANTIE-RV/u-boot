...
#define PLIC_BASE           (0xFFD0000000ULL)                         /*!< PLIC Base Address */
#else
#define PLIC_BASE           (0xFFD8000000ULL)                         /*!< PLIC Base Address */
#endif
#define CORET_BASE          (PLIC_BASE + 0x4000000UL)                 /*!< CORET Base Address */
#define CLINT_BASE          (PLIC_BASE + 0x4000000UL)                 /*!< CLINT Base Address */
