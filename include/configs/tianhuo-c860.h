...
#define INTC_BASEADDRESS            0xfff70000
#define TIMER_BASEADDRESS           0xffc32000
#define ERAGON_MMC0_BASE            0xf7080000
#else
#define INTC_BASEADDRESS            0xbff70000
#define TIMER_BASEADDRESS           0xbfc32000
#define ERAGON_MMC0_BASE            0xb7080000
#endif
...
#define FLASH_SPL_SIZE              0x10000  /* 64K */
...
#define TFTP_LOAD_DTB "tftpboot ${dtb_load_addr_virt} c860/tianhuo_ck860_evb.dtb ; "
#define TFTP_LOAD_SLAVE_DTB "tftpboot ${dtb_load_addr_virt} c810/tianhuo_ck810_evb.dtb ; "
#else
#define TFTP_LOAD_DTB "tftpboot ${dtb_load_addr_virt} c860/tianhuo_ck860.dtb ; "
#define TFTP_LOAD_SLAVE_DTB "tftpboot ${dtb_load_addr_virt} c810/tianhuo_ck810.dtb ; "
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "sram_addr_virt=0xbf800000\0"  /* PHYS_SRAM_1 */ \
