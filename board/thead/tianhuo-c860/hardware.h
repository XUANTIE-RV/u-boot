...
#define SYSREG_BASEADDR      (u32)(0xffc37000)
#define SLAVE_RESET_CONTROL  (u32)(0xffc36108)
...
#define SYSREG_BASEADDR      (u32)(0xbfc37000)
#define SLAVE_RESET_CONTROL  (u32)(0xbfc36108)
